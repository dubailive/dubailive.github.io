...
if( Level > 0  && Level <= 7 )  document.getElementById("LevelDisplay").style.marginLeft = "-287px";
if( Level > 7  && Level <= 14 )  document.getElementById("LevelDisplay").style.marginLeft = "-267px";
if( Level > 14 && Level <= 20 )  document.getElementById("LevelDisplay").style.marginLeft = "-247px";
if( Level > 20 && Level <= 27 ) document.getElementById("LevelDisplay").style.marginLeft = "-226px";
if( Level > 27 && Level <= 37 ) document.getElementById("LevelDisplay").style.marginLeft = "-207px";
if( Level > 37 && Level <= 43 ) document.getElementById("LevelDisplay").style.marginLeft = "-187px";
if( Level > 43 && Level <= 49 ) document.getElementById("LevelDisplay").style.marginLeft = "-166px";
if( Level > 49 && Level <= 55 ) document.getElementById("LevelDisplay").style.marginLeft = "-147px";
if( Level > 55 && Level <= 62 ) document.getElementById("LevelDisplay").style.marginLeft = "-126px";
if( Level > 62 && Level <= 68 ) document.getElementById("LevelDisplay").style.marginLeft = "-107px";
if( Level > 68 && Level <= 74 ) document.getElementById("LevelDisplay").style.marginLeft = "-87px";
...
if( Level > 94 && Level <= 100 ) document.getElementById("LevelDisplay").style.marginLeft = "-7px";
